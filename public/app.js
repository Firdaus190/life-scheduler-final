...
async function api(u, o) { const r = await fetch(u, o); const j = await r.json(); if (!r.ok) throw new Error(j.error || "Terjadi kesalahan"); return j; }
...
refreshPetMood();
setInterval(refreshPetMood, 60000);